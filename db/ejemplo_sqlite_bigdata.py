...
for reg in cur.execute(query1):
    print(reg)
    # print(reg[1])


# con.commit() # Este es necesario para los comandos que realizan cambios en la db


con.close()  # Este es el que va para cerrar la conexión
#con.clear() no anda 